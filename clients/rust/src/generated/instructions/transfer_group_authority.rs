...
/// Accounts.
pub struct TransferGroupAuthority {
...
impl TransferGroupAuthority {
  pub fn instruction(&self, args: TransferGroupAuthorityInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: TransferGroupAuthorityInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
    ...
    let mut data = TransferGroupAuthorityInstructionData::new().try_to_vec().unwrap();
...
pub struct TransferGroupAuthorityInstructionData {
            discriminator: [u8; 8],
                  }

impl TransferGroupAuthorityInstructionData {
  pub fn new() -> Self {
    Self {
                        discriminator: [96, 182, 160, 65, 159, 124, 207, 117],
                                              }
  }
}

impl Default for TransferGroupAuthorityInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct TransferGroupAuthorityInstructionArgs {
                  pub lrp: LightRootParams,
                pub group_seed: u64,
      }


/// Instruction builder for `TransferGroupAuthority`.
///
/// ### Accounts:
///
...
pub struct TransferGroupAuthorityBuilder {
...
impl TransferGroupAuthorityBuilder {
  pub fn new() -> Self {
    Self::default()
  }
            #[inline(always)]
...
#[inline(always)]
  ...
  pub fn instruction(&self) -> solana_program::instruction::Instruction {
    let accounts = TransferGroupAuthority {
          ...
          let args = TransferGroupAuthorityInstructionArgs {
  ...
  /// `transfer_group_authority` CPI accounts.
  pub struct TransferGroupAuthorityCpiAccounts<'a, 'b> {
...
/// `transfer_group_authority` CPI instruction.
pub struct TransferGroupAuthorityCpi<'a, 'b> {
  ...
  pub __program: &'b solana_program::account_info::AccountInfo<'a>,
    ...
    pub __args: TransferGroupAuthorityInstructionArgs,
  }

impl<'a, 'b> TransferGroupAuthorityCpi<'a, 'b> {
  pub fn new(
    program: &'b solana_program::account_info::AccountInfo<'a>,
          accounts: TransferGroupAuthorityCpiAccounts<'a, 'b>,
              args: TransferGroupAuthorityInstructionArgs,
      ) -> Self {
    Self {
      __program: program,
...
/// Instruction builder for `TransferGroupAuthority` via CPI.
///
/// ### Accounts:
///
                      ///   0. `[writable, signer]` authority
          ...
          ///   9. `[]` account_compression_authority
#[derive(Clone, Debug)]
pub struct TransferGroupAuthorityCpiBuilder<'a, 'b> {
  instruction: Box<TransferGroupAuthorityCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> TransferGroupAuthorityCpiBuilder<'a, 'b> {
  pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
    let instruction = Box::new(TransferGroupAuthorityCpiBuilderInstruction {
      __program: program,
              authority: None,
              new_authority: None,
              self_program: None,
  ...
  pub fn invoke_signed(&self, signers_seeds: &[&[&[u8]]]) -> solana_program::entrypoint::ProgramResult {
        ...
        let instruction = TransferGroupAuthorityCpi {
...
#[derive(Clone, Debug)]
struct TransferGroupAuthorityCpiBuilderInstruction<'a, 'b> {
