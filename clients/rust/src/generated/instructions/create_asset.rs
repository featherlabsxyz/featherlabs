...
impl CreateAsset {
    ...
    pub fn instruction_with_remaining_accounts(
        ...
        let mut data = CreateAssetInstructionData::new().try_to_vec().unwrap();
...
pub struct CreateAssetInstructionData {
    discriminator: [u8; 8],
}

impl CreateAssetInstructionData {
    pub fn new() -> Self {
        Self {
...
impl Default for CreateAssetInstructionData {
    fn default() -> Self {
        Self::new()
    }
}
...
pub struct CreateAssetInstructionArgs {
    pub lrp: LightRootParams,
    pub seeds: u64,
    pub args: CreateAssetArgsV1,
}

/// Instruction builder for `CreateAsset`.
///
/// ### Accounts:
///
...
impl CreateAssetBuilder {
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = CreateAssetInstructionArgs {
...
/// `create_asset` CPI accounts.
pub struct CreateAssetCpiAccounts<'a, 'b> {
...
/// `create_asset` CPI instruction.
pub struct CreateAssetCpi<'a, 'b> {
    ...
    pub __args: CreateAssetInstructionArgs,
}

impl<'a, 'b> CreateAssetCpi<'a, 'b> {
    pub fn new(
        program: &'b solana_program::account_info::AccountInfo<'a>,
        accounts: CreateAssetCpiAccounts<'a, 'b>,
        args: CreateAssetInstructionArgs,
    ) -> Self {
        Self {
            __program: program,
...
/// Instruction builder for `CreateAsset` via CPI.
///
/// ### Accounts:
///
///   0. `[writable, signer]` signer
...
///   9. `[]` account_compression_authority
#[derive(Clone, Debug)]
pub struct CreateAssetCpiBuilder<'a, 'b> {
    instruction: Box<CreateAssetCpiBuilderInstruction<'a, 'b>>,
}

impl<'a, 'b> CreateAssetCpiBuilder<'a, 'b> {
    pub fn new(program: &'b solana_program::account_info::AccountInfo<'a>) -> Self {
        let instruction = Box::new(CreateAssetCpiBuilderInstruction {
            __program: program,
            signer: None,
            authority: None,
            self_program: None,
    ...
    pub fn self_program(
        &mut self,
        self_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn noop_program(
        &mut self,
        noop_program: &'b solana_program::account_info::AccountInfo<'a>,
    ) -> &mut Self {
    ...
    pub fn invoke_signed(
        ...
        let instruction = CreateAssetCpi {
            ...
            noop_program: self
                .instruction
                .noop_program
                .expect("noop_program is not set"),
...
#[derive(Clone, Debug)]
struct CreateAssetCpiBuilderInstruction<'a, 'b> {
