...
impl CreateGroup {
  pub fn instruction(&self, args: CreateGroupInstructionArgs) -> solana_program::instruction::Instruction {
    self.instruction_with_remaining_accounts(args, &[])
  }
  #[allow(clippy::vec_init_then_push)]
  pub fn instruction_with_remaining_accounts(&self, args: CreateGroupInstructionArgs, remaining_accounts: &[solana_program::instruction::AccountMeta]) -> solana_program::instruction::Instruction {
...
impl Default for CreateGroupInstructionData {
  fn default() -> Self {
    Self::new()
  }
}
...
pub struct CreateGroupBuilder {
            signer: Option<solana_program::pubkey::Pubkey>,
                ...
                seeds: Option<u64>,
                max_size: Option<u32>,
                metadata: Option<GroupMetadataArgsV1>,
    ...
    pub fn account_compression_authority(&mut self, account_compression_authority: solana_program::pubkey::Pubkey) -> &mut Self {
      ...
      pub fn max_size(&mut self, max_size: u32) -> &mut Self {
        ...
        self
                ...
                /// `[optional argument]`
#[inline(always)]
      pub fn metadata(&mut self, metadata: GroupMetadataArgsV1) -> &mut Self {
