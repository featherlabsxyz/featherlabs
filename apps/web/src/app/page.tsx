...
import {createNftAloneTx} from "@featherlabs/feather-assets/src/nft";
...
export default function CreateNFT() {
    ...
    //         };
    //
    //         // const transaction = await createNftAloneTx(
    //         //     rpc,
    //         //     publicKey,
    //         //     name,
    //         //     uploadedImage,
    ...
    return (
        <motion.div
            ...
            className="container mx-auto px-2 sm:px-4 lg:px-6 mb-20 max-w-7xl"
        >
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 mt-4 lg:mt-20">
                <div
                    ...
                    >
                        <div
                            className="mx-2 sm:mx-4 lg:mx-8 text-[18px] sm:text-[20px] lg:text-[25px] font-archivo font-[900] archivo-heading">
                            Create NFT
                        </div>
                        <div className="mx-2 sm:mx-4 lg:mr-10 flex justify-center">
                            <Link href="/create-collection-nft" className="flex justify-center">
                                <button
                                    ...
                                    <span className="hidden sm:inline">Collection NFT</span>
                                    <span className="sm:hidden">Collection</span>
                                    <svg viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"
                                         id="Arrow-Right-1--Streamline-Ultimate" height="16" width="16"
                    ...
                    >
                        <Label htmlFor="name" className="text-[18px] sm:text-[20px] archivo-label">
                            Name
                        </Label>
                        <Input
                            id="name"
                        ...
                        <div className="flex gap-2 mt-1">
                            <Input
                                ...
                                className="archivo-input flex-[3] text-[14px] sm:text-[16px] text-[#BEBEBE] underline"
                            />
                            <div>
                                <label htmlFor="file-upload" className="cursor-pointer">
                                    <div
                                        className="archivo-input border-[0.5px] border-[#888888] rounded-xl bg-[#6D6477] text-[14px] sm:text-[16px] lg:text-[18px] font-new-black px-2 sm:px-3 lg:px-4 py-[8px] sm:py-[10px] text-white flex items-center justify-center gap-1 sm:gap-2 transition-colors hover:bg-[#4F455A] active:bg-[#463C51]">
                                        <svg
                        ...
                        <p className="archivo-label text-[11px] sm:text-[12px] lg:text-[14px] mt-1 sm:mt-2 text-[#BEBEBE] leading-tight">
                        ...
                        />
                        <p className="archivo-label text-[11px] sm:text-[12px] lg:text-[14px] mt-1 sm:mt-2 text-[#BEBEBE] leading-tight">
                            The description of your NFT or
                            collection.</p>
                        ...
                        <div className="flex items-center mt-4 space-x-2 archivo-label">
                            <Checkbox
                                ...
                                onCheckedChange={(checked) => {
                                    setEnforceRoyalties(checked as boolean);
                                }}
                            />
                            <label
                                htmlFor="terms"
                                className="text-base sm:text-xl archivo-label leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70"
                            >
                                Do you want to enable royalties in future?
                            </label>
                        </div>
                    </motion.div>
                    ...
                    >
                        <div className="mx-2 sm:mx-4 lg:mx-8 text-[18px] sm:text-[20px] lg:text-[25px] font-archivo font-[900] archivo-heading"></div>
                        <div className="mx-2 sm:mx-4 lg:mr-10 flex justify-center">
                            <button className="flex items-center gap-1 sm:gap-2 cursor-pointer border-[0.5px] border-[#888888] rounded-xl bg-[#6D6477] text-[12px] sm:text-[14px] lg:text-[17px] font-new-black px-2 sm:px-3 lg:px-4 py-1 sm:py-2 text-white transition-colors hover:bg-[#4F455A] active:bg-[#463C51]">
                                Create NFT
                            </button>
                        </div>
                    </motion.div>
